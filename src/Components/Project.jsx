            ...
            <div className='w-full h-fit py-24 flex justify-center items-center bg-[rgb(29,29,29)]'>
                <div className='w-[85%] h-fit max-md:w-[90%]'>
                    ...
                    <div className='w-full h-fit grid grid-cols-2 gap-10 mb-5 max-md:grid-cols-1'>
                        <div className='h-fit'>
                            <div className='w-full h-96 rounded-xl'>
                                <img data-aos="fade-right" data-aos-duration='2000' className='w-full h-full rounded-xl' src={process.env.PUBLIC_URL + '/fashionhub.jpg'} />
                            </div>
                        ...
                        <div className='h-fit'>
                            <div className='w-full h-96 rounded-xl'>
                                <img data-aos="fade-left" data-aos-duration='2000' className='w-full h-full rounded-xl' src={process.env.PUBLIC_URL + '/snapify.jpg'} />
                            </div>
                            <div className='w-full h-10 justify-between items-center flex text-white my-3'>
                    ...
                    <div className='w-full h-fit grid grid-cols-3 gap-10 max-md:grid-cols-1'>
                        <div className='h-fit'>
                            <div className='w-full h-96 rounded-xl'>
                                <img data-aos="fade-right" data-aos-duration='2000' className='w-full h-full rounded-xl' src={process.env.PUBLIC_URL + '/handloom.jpg'} />
                            </div>
                            <div className='w-full h-10 justify-between items-center flex text-white my-3'>
                        ...
                        <div className='h-fit'>
                            <div className='w-full h-96 rounded-xl'>
                                <img data-aos="zoom-in" data-aos-duration='3000' className='w-full h-full rounded-xl' src={process.env.PUBLIC_URL + '/photo2.jpg'} />
                            </div>
                            <div className='w-full h-10 justify-between items-center flex text-white my-3'>
                        ...
                        <div className='h-fit'>
                            <div className='w-full h-96 rounded-xl'>
                                <img data-aos="fade-left" data-aos-duration='2000' className='w-full h-full rounded-xl' src={process.env.PUBLIC_URL + '/photo2.jpg'} />
                            </div>
                            <div className='w-full h-10 justify-between items-center flex text-white my-3'>
                                <div data-aos="zoom-out" data-aos-duration='2000' className='w-fit h-fit text-2xl font-semibold max-md:text-xl'>GeekFolio Architecture</div>
                                <div data-aos="zoom-out" data-aos-duration='2000' className='w-fit h-fit text-base'>© 2023</div>
