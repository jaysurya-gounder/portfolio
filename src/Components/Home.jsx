...
function Home() {
    ...
    return (
        <div className='w-full h-screen relative bg-[rgb(29_29_29)] max-md:h-[800px]'>
            ...
            <img className='absolute object-cover md:hidden w-full h-full z-10 bg-[rgb(29_29_29)]  opacity-40 right-0 top-0' src={process.env.PUBLIC_URL + '/photo2.jpg'} />
            <img data-aos="zoom-in" data-aos-duration="5000" className='absolute w-[35%] h-fit right-[10%] top-3 max-md:hidden' src={process.env.PUBLIC_URL + '/main.png'} />
